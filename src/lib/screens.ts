...
export const SCREENS: Screen[] = [
  {
    ...
    rule: "Trailing-12-month revenue ≥ 2× AND TTM net profit ≥ 2× vs 3 quarters ago.",
  ...
  },
  {
    ...
    rule: "Trailing-12-month revenue ≥ 1.5× AND TTM net profit ≥ 1.25× vs 2 quarters ago.",
  ...
  },
  {
    ...
    rule: "Trailing-12-month revenue ≥ 2× vs 3 quarters ago.",
  ...
  },
  {
    ...
    rule: "Trailing-12-month revenue ≥ 1.5× vs 2 quarters ago.",
  ...
  },
  {
    ...
    rule: "TTM revenue ≥ 2× and TTM net profit ≥ 2× vs 8 quarters ago, AND current P/E < 30% of its 8-quarter average P/E.",
    metrics: [
      mRev(8, "Rev 8Q"),
      mProfit(8, "Profit 8Q"),
  ...
  },
  {
    ...
    rule: "TTM revenue ≥ 2× and TTM net profit ≥ 2× vs 4 quarters ago, AND current P/E < 30% of its 4-quarter average P/E.",
    metrics: [
      mRev(4, "Rev 4Q"),
      mProfit(4, "Profit 4Q"),
